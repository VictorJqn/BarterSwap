...
type CreditTransaction struct {
	...
	ExchangeID int    `json:"exchange_id"` // 0 pour les crédits de bienvenue
...
func ValidCategorie(c string) bool { return categories[c] }
func ValidNiveau(n string) bool    { return niveaux[n] }
func ValidStatus(s string) bool    { return statuses[s] }

// ServiceFilter regroupe les critères de recherche d'annonces côté base de données.
