...
func (api *API) listServices(w http.ResponseWriter, r *http.Request) {
	services, err := api.services.List(r.Context(), service.ListServicesInput{
...
func (api *API) createService(w http.ResponseWriter, r *http.Request) {
	...
	svc, err := api.services.Create(r.Context(), providerID, service.CreateServiceInput{
		Titre:        body.Titre,
...
func (api *API) updateService(w http.ResponseWriter, r *http.Request) {
	...
	svc, err := api.services.Update(r.Context(), actorID, id, service.UpdateServiceInput{
		Titre:        body.Titre,
		Description:  body.Description,
		Categorie:    body.Categorie,
		DureeMinutes: body.DureeMinutes,
